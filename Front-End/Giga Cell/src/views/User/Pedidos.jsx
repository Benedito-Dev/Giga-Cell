        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              ...
              <div className="flex justify-center w-full">
                <div className="relative max-w-md w-full">
                  <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-orange-500 bg-white">
                    <input
                      type="date"
                      className="px-3 py-2.5 w-full focus:outline-none text-gray-700"
                      value={filterDate}
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 bg-gray-600"
            >
