...
function NavBarr() {
    return (
        <div className="bg-gray-800 p-4 text-slate-100 flex justify-between items-center">
          ...
          />
          <Link to="/Login">
          <button className="flex items-center justify-center gap-1 m-2 bg-yellow-400 px-4 py-2 rounded-full text-black transition-all hover:text-slate-200 hover:scale-110" ><i className='bx bxs-user'></i> Login</button>
          </Link>
