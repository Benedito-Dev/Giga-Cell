...
function NavBarr() {
    return (
        <div className="bg-gray-800 p-4 text-slate-100 flex justify-between items-center">
            ...
            className="h-16 w-[70vw] px-4 py-2 rounded-full placeholder-black placeholder-opacity-50 italic border bg-slate-100 border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <Link to="/Login">
